# Ejercicio Personalizado - Collections (Implementation)

**Skill Level:** Beginner
**Topic Area:** Collections
...
- **Curso**: Curso .NET
- **Módulo Actual**: Colecciones y Estructuras de Datos (3/12)
...
## Files
- `Ejercicio Personalizado - Collections (Implementation)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - Collections (Implementation)-Solution.cs` - Complete solution (review after attempting)
