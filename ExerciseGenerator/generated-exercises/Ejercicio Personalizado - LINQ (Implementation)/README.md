# Ejercicio Personalizado - LINQ (Implementation)
...
- **Curso**: Curso .NET
- **Módulo Actual**: LINQ y Programación Funcional (Contexto: E-commerce analytics) (3/12)
...
- **Tema**: LINQ
- **Tipo**: Implementation
- **Contexto/Dominio**: E-commerce analytics
...
## Files
- `Ejercicio Personalizado - LINQ (Implementation)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - LINQ (Implementation)-Solution.cs` - Complete solution (review after attempting)
