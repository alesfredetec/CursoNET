# Ejercicio Personalizado - DesignPatterns (Design)
...
- **Curso**: Curso .NET
- **Módulo Actual**: Patrones de Diseño y Arquitectura (Contexto: Microservices architecture) (3/12)
...
- **Tema**: DesignPatterns
- **Tipo**: Design
- **Contexto/Dominio**: Microservices architecture
...
## Files
- `Ejercicio Personalizado - DesignPatterns (Design)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - DesignPatterns (Design)-Solution.cs` - Complete solution (review after attempting)
