# Ejercicio Personalizado - AspNetCore (Implementation)

**Skill Level:** Advanced
**Topic Area:** AspNetCore
...
- **Curso**: Curso .NET
- **Módulo Actual**: ASP.NET Core y Web APIs (Contexto: RESTful API with authentication) (3/12)
...
- **Tema**: AspNetCore
- **Tipo**: Implementation
- **Contexto/Dominio**: RESTful API with authentication
...
## Files
- `Ejercicio Personalizado - AspNetCore (Implementation)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - AspNetCore (Implementation)-Solution.cs` - Complete solution (review after attempting)
