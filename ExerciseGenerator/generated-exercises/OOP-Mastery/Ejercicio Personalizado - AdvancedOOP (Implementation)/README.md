# Ejercicio Personalizado - AdvancedOOP (Implementation)

**Skill Level:** Intermediate
**Topic Area:** AdvancedOOP
...
- **Curso**: Curso .NET
- **Módulo Actual**: POO Avanzada y Principios SOLID (Contexto: E-commerce platform) (3/12)
...
- **Tema Actual**: AdvancedOOP
- **Nivel de Estudiante**: Intermediate
...
- **Tema**: AdvancedOOP
- **Tipo**: Implementation
- **Contexto/Dominio**: E-commerce platform
...
## Files
- `Ejercicio Personalizado - AdvancedOOP (Implementation)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - AdvancedOOP (Implementation)-Solution.cs` - Complete solution (review after attempting)
