# Ejercicio Personalizado - DesignPatterns (Refactoring)
...
- **Curso**: Curso .NET
- **Módulo Actual**: Patrones de Diseño y Arquitectura (Contexto: Legacy system modernization) (3/12)
...
- **Tema Actual**: DesignPatterns
- **Nivel de Estudiante**: Advanced
- **Tipo de Actividad**: Refactoring
...
- **Tema**: DesignPatterns
- **Tipo**: Refactoring
- **Contexto/Dominio**: Legacy system modernization
...
## Files
- `Ejercicio Personalizado - DesignPatterns (Refactoring)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - DesignPatterns (Refactoring)-Solution.cs` - Complete solution (review after attempting)
