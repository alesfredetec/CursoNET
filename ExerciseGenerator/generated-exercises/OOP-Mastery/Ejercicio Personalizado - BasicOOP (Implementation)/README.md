# Ejercicio Personalizado - BasicOOP (Implementation)
...
- **Curso**: Curso .NET
- **Módulo Actual**: Programación Orientada a Objetos Básica (Contexto: Banking system) (3/12)
...
- **Tema**: BasicOOP
- **Tipo**: Implementation
- **Contexto/Dominio**: Banking system
...
## Files
- `Ejercicio Personalizado - BasicOOP (Implementation)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - BasicOOP (Implementation)-Solution.cs` - Complete solution (review after attempting)
