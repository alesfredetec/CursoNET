# Ejercicio Personalizado - MethodsAndParameters (Extension)
...
## Files
- `Ejercicio Personalizado - MethodsAndParameters (Extension)-Starter.cs` - Your starting point
- `Ejercicio Personalizado - MethodsAndParameters (Extension)-Solution.cs` - Complete solution (review after attempting)
